...
setwd('/Users/fco/Desktop/BREMEN_OP/chapter1_2/FST/pairwise_locations/')
...
globals_file <- globals_file[-c(1:9,22:24), ] 
globals_file <- globals_file[-c(6), ] 
...
grobs <- list(anno_pair_spe(spe ="nig",left= "bel",right="pue") %>%
                ggplotGrob(),
...
hypo_save(filename = 'Pairwise_loc_Fst.png',
          plot = p,
          width = 8,
          height = 12)
