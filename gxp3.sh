...
jobfile3=12_prep_gemma3.tmp # temp file
cat > $jobfile3 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=12_prep_gemma3.tmp
#SBATCH --partition=carl.p
#SBATCH --output=$BASE_DIR/logs/12_prep_gemma3_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/12_prep_gemma3_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
...
jobfile4=13_gemma3.tmp # temp file
cat > $jobfile4 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=13_gemma3.tmp
#SBATCH --partition=carl.p
#SBATCH --array=1-18
#SBATCH --output=$BASE_DIR/logs/13_gemma3_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/13_gemma3_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
...
jobfile5=14_windows3.tmp # temp file
cat > $jobfile5 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=14_windows3.tmp
#SBATCH --partition=carl.p
#SBATCH --array=1-18
#SBATCH --output=$BASE_DIR/logs/14_windows3_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/14_windows3_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
