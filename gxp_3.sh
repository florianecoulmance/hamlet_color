...
jobfile0=1.0_remove_samples.tmp # temp file
cat > $jobfile0 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=1.0_remove_samples
#SBATCH --partition=carl.p
#SBATCH --output=$BASE_DIR/logs/1.0_remove_samples_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/1.0_remove_samples_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
jobfile3=12_prep_gemma_109.tmp # temp file
cat > $jobfile3 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=12_prep_gemma_109.tmp
#SBATCH --partition=carl.p
#SBATCH --output=$BASE_DIR/logs/12_prep_gemma_109_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/12_prep_gemma_109_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
...
jobfile4=13_gemma_109.tmp # temp file
cat > $jobfile4 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=13_gemma_109.tmp
#SBATCH --partition=carl.p
#SBATCH --array=1-18
#SBATCH --output=$BASE_DIR/logs/13_gemma_109_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/13_gemma_109_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
...
jobfile5=14_windows_109.tmp # temp file
cat > $jobfile5 <<EOA # generate the job file
#!/bin/bash

#SBATCH --job-name=14_windows_109.tmp
#SBATCH --partition=carl.p
#SBATCH --array=1-18
#SBATCH --output=$BASE_DIR/logs/14_windows_109_%A_%a.out
#SBATCH --error=$BASE_DIR/logs/14_windows_109_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
