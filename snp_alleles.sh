...
sed -i 's/RANGE CHROM POS POS/Unique Peak ID\\tchromosome\\tstarting position\\tending position\\tStrand/g' > $BASE_DIR/outputs/7_gxp/continuous/LAB/LAB_fullm_54off_59on/PC1_5/PC1_5_\${CHROM}_homer.txt
