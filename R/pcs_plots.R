...
color_space <- as.character(args[2])
metadata_path <- as.character(args[3])
...
# p1 <-p1 + geom_point(aes(shape=flash))
# p1 <- p1 + scale_color_manual(values=c('#17202A','#C0392B', '#27AE60','#2E86C1','#F4D03F','#8E44AD','#E67E22','#F772CB','#591402','#3F5202','#1010D4'),
#                             labels = c(abe = "<img src='logos/H_aberrans.l.cairo.png' width='25' /><br>*H. aberrans*",
#                                        chl = "<img src='logos/H_chlorurus.l.cairo.png' width='25' /><br>*H. chlorurus*",
#                                        gem = "<img src='logos/H_gemma.l.cairo.png' width='25' /><br>*H. gemma*",
#                                        gum = "<img src='logos/H_gumigutta.l.cairo.png' width='25' /><br>*H. gummiguta*",
#                                        gut = "<img src='logos/H_guttavarius.l.cairo.png' width='25' /><br>*H. guttavarius*",
#                                        ind = "<img src='logos/H_indigo.l.cairo.png' width='25' /><br>*H. indigo*",
#                                        may = "<img src='logos/H_maya.l.cairo.png' width='25' /><br>*H. maya*",
#                                        nig = "<img src='logos/H_nigricans.l.cairo.png' width='25' /><br>*H. nigricans*",
#                                        pue = "<img src='logos/H_puella.l.cairo.png' width='25' /><br>*H. puella*",
#                                        tan = "<img src='logos/H_tan.l.cairo.png' width='25' /><br>*Tan hamlet*",
#                                        uni = "<img src='logos/H_unicolor.l.cairo.png' width='25' /><br>*H. unicolor*"))
# p1 <- p1 + scale_shape_manual(values = c(16,3), labels = c(Off = "flash OFF", On = "flash ON"))
# p1 <- p1 + theme(legend.position="bottom",legend.title=element_blank(),legend.box = "vertical",legend.text =  element_markdown(size = 6))
# p1 <- p1 + guides(color = guide_legend(nrow = 1))
# p1
# 
# hypo_save(filename = 'left_110_31off/LAB_PCA_flash_separation.png',
#           plot = p1,
#           width = 10,
#           height = 8)
