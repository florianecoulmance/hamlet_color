...
traits <- list("bars_body", "bars_head", "peduncle", "snout", "H.unicolor", "H.aberrans", "H.nigricans", "H.maya", "H.gemma", "H.puella", "H.indigo","H.gummiguta", "Tan.hamlet", "H.guttavarius", "H.floridae", "H.chlorurus")

for(i in 1:length(traits)) {
  
  pdf(paste0("plot_",traits[i],".pdf",spe=""))
