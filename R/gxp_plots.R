...
if (analysis == "univariate_gemma"){
  ...
  if (analysis == "multivariate_plink_PC1") {
    ...
    print(files)
    traits <- list("PC1_10", "PC1_11", "PC1_12", "PC1_13", "PC1_14", "PC1_15", "PC1_2", "PC1_3", "PC1_4", "PC1_5", "PC1_6", "PC1_7", "PC1_8", "PC1_9")
    print(traits)
    ...
    print(files)
    traits <- list("PC2_10", "PC2_11", "PC2_12", "PC2_13", "PC2_14", "PC2_15", "PC2_3", "PC2_4", "PC2_5", "PC2_6", "PC2_7", "PC2_8", "PC2_9")
    print(traits)
    files_l <- concat_files_plk(files,data_path)
    ...
    print(files)
    traits <- list("PC3_10", "PC3_11", "PC3_12", "PC3_13", "PC3_14", "PC3_15", "PC3_4", "PC3_5", "PC3_6", "PC3_7", "PC3_8", "PC3_9")
    print(traits)
    files_l <- concat_files_plk(files,data_path)
    ...
    print(files)
    traits <- list("PC4_10", "PC4_11", "PC4_12", "PC4_13", "PC4_14", "PC4_15", "PC4_5", "PC4_6", "PC4_7", "PC4_8", "PC4_9")
    print(traits)
    files_l <- concat_files_plk(files,data_path)
    ...
    print(files)
    traits <- list("PC5_10", "PC5_11", "PC5_12", "PC5_13", "PC5_14", "PC5_15", "PC5_6", "PC5_7", "PC5_8", "PC5_9")
    print(traits)
    files_l <- concat_files_plk(files, data_path)
    ...
    print(files)
    traits <- list("PC6_10", "PC6_11", "PC6_12", "PC6_13", "PC6_14", "PC6_15", "PC6_7", "PC6_8", "PC6_9")
    print(traits)
    files_l <- concat_files_plk(files, data_path)
    ...
    print(files)
    traits <- list("PC7_10", "PC7_11", "PC7_12", "PC7_13", "PC7_14", "PC7_15", "PC7_8", "PC7_9")
    print(traits)
    files_l <- concat_files_plk(files, data_path)
    ...
    print(files)
    traits <- list("PC8_10", "PC8_11", "PC8_12", "PC8_13", "PC8_14", "PC8_15", "PC8_9")
    print(traits)
    files_l <- concat_files_plk(files, data_path)
