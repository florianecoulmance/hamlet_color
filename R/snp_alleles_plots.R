  ...
  p <- ggplot(data = dat) +
    ...
    scale_fill_manual(values=c("abe"="#E5E5A1",
                      ...
                      labels = c("abe" = "<img src='/Users/fco/Desktop/PhD/1_CHAPTER1/0_IMAGES/after_python/logos/H_aberrans.l.cairo.png' width='40' /><br>*H. aberrans*",
                                 "aff" = "<img src='/Users/fco/Desktop/PhD/1_CHAPTER1/0_IMAGES/after_python/logos/H_tan.l.cairo.png' width='40' /><br>*H. affinis*",
                                 ...
                                 "tan" = "<img src='/Users/fco/Desktop/PhD/1_CHAPTER1/0_IMAGES/after_python/logos/H_tan.l.cairo.png' width='40' /><br>*H. affinis*")) + 
